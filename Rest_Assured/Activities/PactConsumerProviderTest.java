...
public class PactConsumerProviderTest {
    ...
    public RequestResponsePact createPact(PactDslWithProvider builder) throws ParseException {
        ...
        DslPart requestResponseBody = new PactDslJsonBody()
                .numberType("id", 1)
                .stringType("firstName", "Jyothi")
                .stringType("lastName", "Shetty")
                .stringType("email", "jyothishetty@test.com");
    ...
    public void runTest() {
        ...
        map.put("id", 1);
        map.put("firstName", "Jyothi");
        map.put("lastName", "Shetty");
        map.put("email", "jyothishetty@test.com");
